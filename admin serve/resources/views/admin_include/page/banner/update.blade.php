...
<section id="main-content">
 ...
 <div class="panel panel-default row">
    ...
    <form  class="row" >
        ...
        @endif
    <div class="col-4">
        <img src="{{$item_theloai->theloai_link_img}}" class="img-upload" alt="">
    </div>
    <div class="col-8 row">
        <div class="col-5">
        ...
        <div class="col-6">
            ...
            <div class="col-12 ip-form">
                ...
                <input id="photo"  type="file" id="file-upload-up" class="bder-none file-upload" value="" > </div>
            <div class="col-12 err"><span>
                @error('category_code')
                {{ $message }}
                    @enderror 
        ...
        <div class="col-12 " style="display: none"><p class="dis-none">{{  $item_theloai->theloai_id }}</p> </div>
        <div class="col-12 ip-form">
            <button  id="up_theloai"  type="submit" name="add-category"><i class="fa-solid fa-pen"></i> Cập nhật thể loại</button>
        </div>
    </div>
