...
<section id="main-content">
 ...
 <div class="panel panel-default row">
    ...
    <div class="col-12">
      <table id="theloaiTable" class="table" ui-jq="footable" ui-options='{
        "paging": {
          "enabled": true
        },
        "filtering": {
        ...
        <thead >
          <tr>
            ...
            <th class="flex_center ">
               <div data-status="all"  id="filterAll" class="fiter-status-theloai filter-option td-table-titel">
                Trạng thái 
             </div> 
      ...
      @endphp
          <tr data-expanded="true" class="theloai-item">
            ...
            <td  class="d-flex  align-items-center">
              <div style="min-height: 35px" class="img_child"><img class="img_child_icon" src="{{ $item_theloai->theloai_link_img }}" alt=""> 
                {{ $item_theloai->theloai_name }}</div> </td>
            ...
            <td ><div class="flex_center icons">
                <div class="icon bg-bule flex_center">
                 <a href="{{ route('theloai_update', ['theloai_id' => $item_theloai->theloai_id]) }}"> <i class="fa-solid fa-pen"></i></a> 
                </div>
                <div class="icon bg-red flex_center">
                    <a onclick="return confirm('Bạn có muốn xóa không ?')" href="{{ route('theloai_delete', ['theloai_id' => $item_theloai->theloai_id]) }}"><i class="fa-sharp fa-solid fa-trash"></i></a> 
                </div>
            </div></td>
          </tr>
          @endforeach
