      ...
      @endphp
          <tr data-expanded="true">
            ...
            <td style="text-align: center">
              <p class="reslut_categgory_icon" style="display: none">{{ $item_product->product_status }}</p>
              ...
              <div class="icon bg-yellow flex_center">
                <a href="{{route('product_deatil',['product_id' => $item_product->product_id ])}}"><i class="fa-solid fa-eye"></i></a>  
              </div>  
              <div class="icon bg-bule flex_center">
                 <a href="{{ route('product_update', ['product_id' => $item_product->product_id ]) }}"> <i class="fa-solid fa-pen"></i></a> 
                </div>
                <div class="icon bg-red flex_center">
                    <a onclick="return confirm('Bạn có muốn xóa không ?')" href="{{ route('product_delete', ['product_id' => $item_product->product_id ]) }}"><i class="fa-sharp fa-solid fa-trash"></i></a> 
                </div>
            </div></td>
          </tr>
          @endforeach
